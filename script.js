...
/* ===== Loader ===== */
// Oculta el contenedor del loader una vez que
...
/* ===== Header ===== */
// Cambia la clase del encabezado cuando el usuario
// hace scroll en la página. Si el usuario ha hecho
//scroll hacia abajo, se añade la clase 'abajo'.
...
/* ===== Botón Menú ===== */
// Muestra u oculta el menú de navegación cuando
// se hace clic en el botón del menú.
...
// Añade una clase "active" al enlace de navegación
// correspondiente a la sección visible en la ventana
// de visualización. Esto permite destacar la sección
// en la barra de navegación mientras se hace scroll.
window.addEventListener("scroll", () => {
...
// Muestra un botón para volver al principio
//de la página cuando el usuario hace scroll
// hacia abajo.
...
// Añade un comportamiento de scroll suave
